...
const syncronization = async (req, res) => {
    ...
    await Deposit.bulkCreate([
        {amount: 200, destination_account: 1, responsible_username: 'user3', date_time: new Date(Date.now())},
        {amount: 50, destination_account: 1, responsible_username: 'user3', date_time: new Date(Date.now())},
        {amount: 100, destination_account: 2, responsible_username: 'user3', date_time: new Date(Date.now())},
        {amount: 200, destination_account: 3, responsible_username: 'user3', date_time: new Date(Date.now())},
        {amount: 300, destination_account: 1, responsible_username: 'user3', date_time: new Date(Date.now())},
        {amount: 500, destination_account: 4, responsible_username: 'user3', date_time: new Date(Date.now())},
        {amount: 600, destination_account: 6, responsible_username: 'user3', date_time: new Date(Date.now())},
        {amount: 200, destination_account: 3, responsible_username: 'user3', date_time: new Date(Date.now())},
        {amount: 50, destination_account: 5, responsible_username: 'user3', date_time: new Date(Date.now())},
        {amount: 100, destination_account: 8, responsible_username: 'user3', date_time: new Date(Date.now())},
        {amount: 200, destination_account: 9, responsible_username: 'user3', date_time: new Date(Date.now())},
        {amount: 300, destination_account: 10, responsible_username: 'user3', date_time: new Date(Date.now())},
        {amount: 500, destination_account: 10, responsible_username: 'user3', date_time: new Date(Date.now())},
        {amount: 600, destination_account: 2, responsible_username: 'user3', date_time: new Date(Date.now())},
        {amount: 200, destination_account: 3, responsible_username: 'user3', date_time: new Date(Date.now())},
        {amount: 50, destination_account: 5, responsible_username: 'user3', date_time: new Date(Date.now())},
        {amount: 100, destination_account: 7, responsible_username: 'user3', date_time: new Date(Date.now())},
        {amount: 200, destination_account: 9, responsible_username: 'user3', date_time: new Date(Date.now())},
        {amount: 300, destination_account: 3, responsible_username: 'user3', date_time: new Date(Date.now())},
        {amount: 500, destination_account: 8, responsible_username: 'user3', date_time: new Date(Date.now())},
        {amount: 600, destination_account: 9, responsible_username: 'user3', date_time: new Date(Date.now())},
        {amount: 200, destination_account: 6, responsible_username: 'user3', date_time: new Date(Date.now())},
        {amount: 50, destination_account: 4, responsible_username: 'user3', date_time: new Date(Date.now())},
        {amount: 100, destination_account: 5, responsible_username: 'user3', date_time: new Date(Date.now())},
        {amount: 200, destination_account: 1, responsible_username: 'user3', date_time: new Date(Date.now())},
        {amount: 300, destination_account: 4, responsible_username: 'user3', date_time: new Date(Date.now())},
        {amount: 500, destination_account: 7, responsible_username: 'user3', date_time: new Date(Date.now())},
        {amount: 600, destination_account: 2, responsible_username: 'user3', date_time: new Date(Date.now())},
    ]);
    await Withdrawal.bulkCreate([
        {amount: 200, origin_account: 2, responsible_username: 'user3', date_time: new Date(Date.now())},
        {amount: 200, origin_account: 3, responsible_username: 'user3', date_time: new Date(Date.now())},
        {amount: 200, origin_account: 6, responsible_username: 'user3', date_time: new Date(Date.now())},
        {amount: 200, origin_account: 2, responsible_username: 'user3', date_time: new Date(Date.now())},
        {amount: 200, origin_account: 1, responsible_username: 'user3', date_time: new Date(Date.now())},
        {amount: 200, origin_account: 8, responsible_username: 'user3', date_time: new Date(Date.now())},
        {amount: 200, origin_account: 5, responsible_username: 'user3', date_time: new Date(Date.now())},
        {amount: 200, origin_account: 2, responsible_username: 'user3', date_time: new Date(Date.now())},
        {amount: 200, origin_account: 9, responsible_username: 'user3', date_time: new Date(Date.now())},
        {amount: 200, origin_account: 10, responsible_username: 'user3', date_time: new Date(Date.now())},
        {amount: 200, origin_account: 10, responsible_username: 'user3', date_time: new Date(Date.now())},
        {amount: 200, origin_account: 9, responsible_username: 'user3', date_time: new Date(Date.now())},
        {amount: 200, origin_account: 4, responsible_username: 'user3', date_time: new Date(Date.now())},
        {amount: 200, origin_account: 6, responsible_username: 'user3', date_time: new Date(Date.now())},
        {amount: 200, origin_account: 9, responsible_username: 'user3', date_time: new Date(Date.now())}
    ]);
