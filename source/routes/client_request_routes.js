...
const { get_request_by_id, create_loan_request, create_card_cancellation_request, create_update_data_request, create_account_request, create_debit_card_request, create_credit_card_request, get_all_request, get_request_between_two_dates, deny_request } = require('../controllers/client_request_controller');
