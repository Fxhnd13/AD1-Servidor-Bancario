...
const { transfer_on_app, account_statement, account_available_for_debit_card, create_account, get_all_accounts, get_account_by_id, update_account,do_withdrawal, do_deposit, get_all_transactions, get_all_transactions_by_an_user } = require('../controllers/account_controller');
...
router.get('/account/get_all_transactions', get_all_transactions);
router.get('/account/get_all_transactions_by_an_user', get_all_transactions_by_an_user);
