...
const { transfer_on_app, account_statement, account_avaliable_for_debit_card, create_account, get_all_accounts, get_account_by_id, update_account,do_withdrawal, do_deposit } = require('../controllers/account_controller');
