...
const { loan_statement, create_loan, get_all_loans, get_loan_by_id, update_loan, do_loan_payment } = require('../controllers/loan_controller');
...
router.post('/loan/payment', do_loan_payment);
