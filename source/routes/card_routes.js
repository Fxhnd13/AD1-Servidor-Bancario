...
const { card_statement, create_card, do_credit_card_payment_to_bank, card_cancellation, do_payment } = require('../controllers/card_controller');
...
router.post('/card/credit_payment', do_credit_card_payment_to_bank);
